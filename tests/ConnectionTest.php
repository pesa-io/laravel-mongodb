...
class ConnectionTest extends TestCase
{
    public function testConnection()
    {
        ...
        $this->assertInstanceOf('Pesa\Mongodb\Connection', $connection);
    }
    ...
    public function testCollection()
    {
        ...
        $this->assertInstanceOf('Pesa\Mongodb\Query\Builder', $collection);
    ...
    public function testSchemaBuilder()
    {
        ...
        $this->assertInstanceOf('Pesa\Mongodb\Schema\Builder', $schema);
    }
