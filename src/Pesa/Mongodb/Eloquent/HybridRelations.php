...
use Pesa\Mongodb\Helpers\EloquentBuilder;
use Pesa\Mongodb\Relations\BelongsTo;
use Pesa\Mongodb\Relations\BelongsToMany;
use Pesa\Mongodb\Relations\HasMany;
use Pesa\Mongodb\Relations\HasOne;
use Pesa\Mongodb\Relations\MorphTo;
use Pesa\Mongodb\Relations\MorphMany;
use Pesa\Mongodb\Relations\MorphOne;
...
trait HybridRelations
{
    ...
    public function hasOne($related, $foreignKey = null, $localKey = null)
    {
        ...
        if (!is_subclass_of($related, \Pesa\Mongodb\Eloquent\Model::class)) {
